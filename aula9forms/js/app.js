...
dataNas.addEventListener('blur', ()=>{
    if(regexDataNas.test(convt(dataNas.value))){
        document.querySelector('.dataNas-certo').style.display='block';
        document.querySelector('.dataNas-incorreto').style.display='none';
        document.querySelector('.dataNas-erro').style.display='none';
        dataNas.style.border='2px solid green';
        return
    }
    if(dataNas.value.trim()==""){
        document.querySelector('.dataNas-erro').style.display='block'; 
        document.querySelector('.dataNas-incorreto').style.display='none';
        document.querySelector('.dataNas-certo').style.display='none';
        return
    }
    document.querySelector('.dataNas-erro').style.display='none';
    document.querySelector('.dataNas-certo').style.display='none';
    document.querySelector('.dataNas-incorreto').style.display='block';
